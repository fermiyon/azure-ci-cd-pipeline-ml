...
[![Build Status](https://dev.azure.com/odluser257262/flask-ml/_apis/build/status%2Ffermiyon.azure-ci-cd-pipeline-ml?branchName=build-deploy)](https://dev.azure.com/odluser257262/flask-ml/_build/latest?definitionId=1&branchName=build-deploy)
...
make install
```
![screenshot](screenshots/azure-make-install.png)

#### 3.8 Create Azure App Service
...
#### 3.10 Output of a Test Run on Azure


### 4. Azure DevOps
Go to dev.azure.com
#### 4.1 Change Azure organization settings to allow public projects
...
#### 5.4 Open the instructions of the Agent
Under project settings -> Agent Pools
...
#### 5.5 Configure the self-hosted agent VM
